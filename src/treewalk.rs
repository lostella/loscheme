...
fn parse_expression(tokens: &mut Peekable<Tokenizer>) -> Result<Expr, String> {
    match tokens.next() {
...
impl Expr {
    ...
    fn into_vec(self) -> Result<Vec<Expr>, String> {
        let mut res = Vec::new();
        let mut cur = self;
        loop {
            match cur {
    ...
    fn borrow_vec(&self) -> Result<Vec<&Expr>, String> {
        let mut cur = self;
        let mut res = Vec::new();
        loop {
            match cur {
    ...
    fn lt(&self, other: &Expr) -> Result<Expr, String> {
        match (self, other) {
    ...
    fn gt(&self, other: &Expr) -> Result<Expr, String> {
        match (self, other) {
            (Expr::Integer(a), Expr::Integer(b)) => Ok(Expr::Bool(a > b)),
            (Expr::Integer(a), Expr::Float(b)) => Ok(Expr::Bool((*a as f64) > *b)),
            (Expr::Float(a), Expr::Float(b)) => Ok(Expr::Bool(a > b)),
    ...
    fn leq(&self, other: &Expr) -> Result<Expr, String> {
        match (self, other) {
            (Expr::Integer(a), Expr::Integer(b)) => Ok(Expr::Bool(a <= b)),
            (Expr::Integer(a), Expr::Float(b)) => Ok(Expr::Bool((*a as f64) <= *b)),
            (Expr::Float(a), Expr::Float(b)) => Ok(Expr::Bool(a <= b)),
    ...
    fn geq(&self, other: &Expr) -> Result<Expr, String> {
        match (self, other) {
            (Expr::Integer(a), Expr::Integer(b)) => Ok(Expr::Bool(a >= b)),
            (Expr::Integer(a), Expr::Float(b)) => Ok(Expr::Bool((*a as f64) >= *b)),
            (Expr::Float(a), Expr::Float(b)) => Ok(Expr::Bool(a >= b)),
    ...
    fn iseq(&self, other: &Expr) -> Result<Expr, String> {
        match (self, other) {
            (Expr::Integer(a), Expr::Integer(b)) => Ok(Expr::Bool(a == b)),
            (Expr::Integer(a), Expr::Float(b)) => Ok(Expr::Bool(*a as f64 == *b)),
            (Expr::Float(a), Expr::Float(b)) => Ok(Expr::Bool(a == b)),
